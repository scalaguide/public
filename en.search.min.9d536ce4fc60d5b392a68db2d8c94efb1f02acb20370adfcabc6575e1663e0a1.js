...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bc8cad2b04a0b20d20d37d685cbee26bad2d241acef8fee1309d4423ee894b21.js',function(){input.required=false;search();});}
